...
export class InsertOrganizationsComponent implements OnInit {
  ...
  async ngOnInit() {
    this.province = (
      await this.dropdownService.getProvinceAll().toPromise()
    ).data;
    this.provinceContact = (
      await this.dropdownService.getProvinceAll().toPromise()
    ).data;
  ...
  public async showDistrict(data) {
    this.district = (
      await this.dropdownService.getDistrictByProvince(data).toPromise()
    ).data;
  }
  ...
  public async showSubdistrict(data) {
    ...
    this.subdistrict = (
      await this.dropdownService.getSubdistrictByDistrict(data).toPromise()
    ).data;
  }

  public async showDistrictContact(data) {
    this.districtContact = (
      await this.dropdownService.getDistrictByProvince(data).toPromise()
    ).data;
  }
    ...
    if (this.corperationId) {
      ...
      Swal.fire({
        ...
        if (result.value) {
          ...
          this.getCorporationContactId(this.corperationId)
          this.getid.find(function (item) {
            if (item.Contact == model.Contact) {
              model.CorporationContactId = item.CorporationContactId
            }
          })
  ...
  public async getCorporationContactId(corperationId) {
    this.getid =
      (
        await this.organizationService
          .getcorporationcontact(corperationId)
          .toPromise()
      ).data || [];
  }
